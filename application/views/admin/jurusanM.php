<html>
    <head>
        <title>Dashboard - Jurusan management</title>
                                                ...
                                                foreach ($jurusan as $ad) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-danger" href="#" data-toggle="modal" data-target="#modal<?php echo $ad['idJurusan']; ?>">
                                                                <i class="fe fe-delete"></i> Delete</a>
                                                            <div class="modal fade" id="modal<?php echo $ad['idJurusan']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog modal-danger" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form action="<?= base_url('executive/hapus/jurusan/' . $ad['idJurusan']) ?>" method="post">
                                                                            <div class="modal-body">
                                                                                <span>Apa anda yakin ingin menghapus data <?= $ad['idJurusan'] ?>?</span>
                                                                            </div>
